...
class TenantMemcachedSessionHandler extends CacheBasedSessionHandler
{
    ...
    protected function getTenantKey(string $sessionId): string
    {
        ...
        // Throw error for untested driver
    ...
    /**
     * Get tenant-specific session prefix for debugging.
     */
    public function getTenantPrefix(?int $tenantId = null): string
    {
        ...
        return "tenant_{$tenantId}:session:";
    }
}
